 ...
 */
function createTaskMappingsTable(db: Database.Database): void {
  db.exec(`
 ...
 */
function createSyncQueueTable(db: Database.Database): void {
  db.exec(`
 ...
 */
function createConflictsTable(db: Database.Database): void {
  db.exec(`
 ...
 */
function createErrorLogTable(db: Database.Database): void {
  db.exec(`
